...
function genValuePartial_toObject(gen, field, fieldIndex, prop) {
  ...
  if (field.resolvedType) {
    ...
    switch (field.type) {
      ...
      ("d%s=o.longs===String?String(m%s):typeof o.longs==='function'?o.longs(m%s):m%s", prop, prop, prop, prop)
      ("else") // Long-like
...
converter.toObject = function toObject(mtype) {
  ...
  ("if(o.defaults){");
    for (i = 0; i < normalFields.length; ++i) {
      ...
      ("d%s=o.longs===String?n.toString():o.longs===Number?n.toNumber():typeof o.longs==='function'?o.longs(n):n", prop)
      ("}else")
      ("d%s=o.longs===String?%j:typeof o.longs==='function'?o.longs(%d):%d", prop, field.typeDefault.toString(), field.typeDefault.toNumber(), field.typeDefault.toNumber());
